...
// publicatii
std::vector<int> SearchService::filtreazaPublicatiiDupaTip(
...
std::vector<int> SearchService::filtreazaPublicatiiDupaAutor(
    const std::vector<std::shared_ptr<Publicatie>>& publicatii,
...
// autor
std::vector<int> SearchService::filtreazaAutoriNume(
...
// clienti
std::vector<int> SearchService::filtreazaClientiUsername(
...
std::vector<int> SearchService::filtreazaClientiEmail(
    const std::vector<Client>& clienti,
...
// comenzi
std::vector<int> SearchService::toateComenzile(
